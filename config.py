...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '2081485237:AAGg3M7z9Y8z5Iw5L55yn_TDRhMuPpEWL24' # Get it from https://t.me/BotFather
    APP_ID = '8388168' # Get it from my.telegram.org/apps
    API_HASH = '6841f3f5438d07fe9bb30dae3a4f3f25' # Get it from my.telegram.org/apps
